            ...
            <div class="col-md-7">
              ...
              <form action="#" method="post">
                <div class="form-group first">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan Nama Lengkap" id="username" />
                </div>
                <div class="form-group first">
                ...
                <div class="form-group last mb-3">
                  ...
                  <input type="password" class="form-control" placeholder="Konfirmasi Password Anda" id="password" />
                </div>
