<header class="navbar navbar-light sticky-top flex-md-nowrap p-2 shadow bg-light">
    <a class="navbar-brand mt-2 mb-2" href="#">
      <a href="/" class="navbar-brand">
        <img src="<?php echo e(asset('img/internal/POTRET.In.png')); ?>" alt="" width="100" class="d-inline-block align-text-top">
      </a>
    </a>
    ...
    <div class="navbar-nav">
      <div class="nav-item text-nowrap me-3">
        ...
        <?php else: ?>
          <a href="<?php echo e(route('loginpage')); ?>" type="button" class="btn btn-secondary">Login</a>
          <a href="<?php echo e(route('registerpage')); ?>" type="button" class="btn btn-warning">Register</a>
        <?php endif; ?>
      </div>
    </div>
</header><?php /**PATH C:\xampp\htdocs\SI4301_Kelompok04_Potret.in\resources\views/partial/navbar.blade.php ENDPATH**/ ?>