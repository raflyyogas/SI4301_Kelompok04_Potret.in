                ...
                <div class="fallback">
                    ...
                    <tr>
                        ...
                        <a href="#" target="_blank" style="color:#1a2b68">
                            <img src="<?php echo e(asset('img/imgvendor/'.$jasa->gambar)); ?>" alt="Alt" style="display:block; border:none;" width="600" height="400" class="img">
                            </a>
                        </td>
                    </tr>
                    </table>
...
<?php echo $__env->make('vendor.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI4301_Kelompok04_Potret.in\resources\views/vendor/view.blade.php ENDPATH**/ ?>