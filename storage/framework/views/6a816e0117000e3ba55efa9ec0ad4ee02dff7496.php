...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Page Content -->
    <div class="container">
        <h1 class="fw-light text-center text-lg-start mt-4 mb-0"><?php echo e($jasa->namaJasa); ?></h1>
    ...
    <div class="container text-center">
        ...
        <p>Fotografi </p>
        <form class="mb-5"method="POST" enctype="multipart/form-data" action="<?php echo e(route('create')); ?>">
            <?php echo csrf_field(); ?>
            <div class="mb-3" hidden>
                <label for="exampleFormControlInput1" class="form-label">ID Customer</label>
                <input type="number" class="form-control" id="exampleFormControlInput1" name="customer" value="<?php echo e($cust->id); ?>" readonly>
            </div>
            <div class="mb-3" hidden>
                <label for="exampleFormControlInput1" class="form-label">ID Jasa</label>
                <input type="number" class="form-control" id="exampleFormControlInput1" name="jasa" value="<?php echo e($jasa->id); ?>" readonly>
            </div>
            <div class="mb-3" hidden>
            ...
            <div class="mb-3" hidden>
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" name="harga" value="<?php echo e($jasa->harga); ?>">
            </div>
            <div class="d-grid gap-2 col-3 mx-auto">
                <b><td>Rp <?php echo e(number_format($jasa->harga, 0, ",", ".")); ?></td></b>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI4301_Kelompok04_Potret.in\resources\views/choose.blade.php ENDPATH**/ ?>